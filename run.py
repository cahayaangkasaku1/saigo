...
while emails:
    ...
    try:
        ...
        driver.find_element(By.ID, "username").send_keys("xtur16+melaripi@gmail.com")
        ...
        element = driver.find_element(By.XPATH, "//a[contains(@href, '/start/repos/dtmdtn%2Fbluise') and contains(@aria-label, 'bluise')]")
        actions.move_to_element(element).perform()
        time.sleep(2)
